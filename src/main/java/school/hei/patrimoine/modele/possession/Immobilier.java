    ...
    public Possession projectionFuture(LocalDate tFutur) {
        if (tFutur.isBefore(dateAcquisition)) {
            return new Immobilier(
                    nom, dateAcquisition, tFutur, new Argent(0, valeurComptable.devise()), tauxDAppreciationAnnuelle);
        }
        ...
        return new Immobilier(
                nom, dateAcquisition, tFutur, valeurF.lt(0) ? new Argent(0, devise()) : valeurF, tauxDAppreciationAnnuelle);
    }
